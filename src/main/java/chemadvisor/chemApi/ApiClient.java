...
import chemadvisor.chemApi.auth.Authentication;
import chemadvisor.chemApi.auth.HttpBasicAuth;
import chemadvisor.chemApi.auth.ApiKeyAuth;
import chemadvisor.chemApi.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://sandbox.chemadvisor.io/chem/rest/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("app_key", new ApiKeyAuth("header", "app_key"));
        authentications.put("app_id", new ApiKeyAuth("header", "app_id"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.chemadvisor.io/chem/rest/v2
